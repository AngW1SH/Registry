...
export interface PluginTeamBuilderDraft extends Schema.CollectionType {
...
export interface PluginTeamBuilderTeamDraft extends Schema.CollectionType {
...
export interface ApiCategoryCategory extends Schema.SingleType {
  ...
  attributes: {
    Featured: Attribute.DynamicZone<
      ['detailed-category.detailed-category', 'image-category.image-category']
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiFormForm extends Schema.CollectionType {
  ...
  attributes: {
    ...
    identifiers: Attribute.Component<'user-identifier.user-identifier', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
