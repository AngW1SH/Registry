import { TeamListStrapiPopulatedWithAdministrators } from "@/db/strapi/types/team";

export const staticTeamListStrapiPopulatedWithAdministrators: TeamListStrapiPopulatedWithAdministrators =
  {
    data: [
      {
        id: 5,
