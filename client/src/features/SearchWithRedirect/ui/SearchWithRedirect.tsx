  ...
  return (
    <div>
      ...
      <div className="flex flex-col flex-wrap rounded-2xl sm:flex-row lg:flex-nowrap lg:rounded-full">
        ...
        <div className="relative ml-auto flex w-full items-center bg-white px-10 py-4 before:absolute before:bottom-0 before:left-[5%] before:h-px before:w-[90%] before:bg-[#848686] after:absolute after:right-0 after:top-[10%] after:hidden after:h-[80%] after:w-px after:bg-[#848686] sm:order-3 sm:w-1/2 sm:rounded-bl-lg sm:px-2 sm:before:hidden sm:after:block lg:order-2 lg:w-auto lg:rounded-none xl:px-4">
          <CalendarInput
            placeholder="Срок записи на проект"
            className="w-full text-sm sm:pl-5 lg:w-48 lg:text-xs xl:w-60 xl:text-sm"
          />
        </div>
        <div className="relative  flex items-center rounded-b-lg bg-white px-10 py-4 after:absolute after:right-0 after:top-[10%] after:hidden after:h-[80%] after:w-px after:bg-[#848686] sm:order-4 sm:w-1/2 sm:rounded-r-lg sm:rounded-bl-none sm:px-2 lg:order-3 lg:w-auto lg:rounded-none lg:py-2 lg:after:block xl:px-4">
          <CalendarInput
            placeholder="Срок реализации"
            className="w-full text-sm lg:w-48 lg:text-xs xl:w-60 xl:text-sm"
          />
        </div>
